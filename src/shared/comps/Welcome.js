...
const Welcome = () => <header className='vh-100 w-100'>
  <div className='bg-near-white h-100'>
    <div className='tc-ns pa3'>
      <h1 className='f2 f1-m f-headline-l fw2 black mt2 mb3 lh-title'>dźwiękowaMapa.pl</h1>
      <h2 className='fw1 f2-l f3 black-60 mv3'>kolekcja nagrań audiosfery Wrocławia</h2>
      <Link
        to={'/rec/313303431'}
      ...
      <footer className='absolute bottom-0 right-0 f6 pa2'>
