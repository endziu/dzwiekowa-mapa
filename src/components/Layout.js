  ...
  render () {
    ...
    return (
      <div className='App flex-auto flex-ns flex-row-ns justify-end f6 black-80 bg-white'>
        ...
        <div className='App-main w-100 vh-40 vh-100-ns fadeIn animated ph1 pt1 fadeInDown animated'>
          {this.props.children}
        </div>
        <div className='flex flex-column vh-60 vh-100-ns w-100 mw6-ns ph1 bl-m bl-l fadeInRight animated'>
