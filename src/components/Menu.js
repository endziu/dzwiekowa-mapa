        ...
        <nav className='flex flex-column-ns flex-row'>
          <div className='flex flex-column-ns flex-row animated fadeIn'>
            <Link
              ...
              <svg className='w1-7' viewBox='0 0 32 32' fill='currentcolor'>
            ...
            <Link
              to={`/rec/${this.props.currentId}`}
              title={'Mapa'}
              className='f5 no-underline black bg-white bg-animate hover-bg-black hover-white inline-flex items-center pa1 ba border-box mb1 mr1'>
              <svg className='w1-7' viewBox='0 0 24 24' fill='currentcolor'>
                <path d='M20.5 3l-.16.03L15 5.1 9 3 3.36 4.9c-.21.07-.36.25-.36.48V20.5c0 .28.22.5.5.5l.16-.03L9 18.9l6 2.1 5.64-1.9c.21-.07.36-.25.36-.48V3.5c0-.28-.22-.5-.5-.5zM15 19l-6-2.11V5l6 2.11V19z' />
              </svg>
            </Link>

            <Link
              to={`/imgs/${this.props.currentId}`}
              title={'Zdjęcia'}
              className='f5 no-underline black bg-white bg-animate hover-bg-black hover-white inline-flex items-center pa1 ba border-box mb1 mr1'>
              <svg className='w1-7' viewBox='0 0 24 24' fill='currentcolor'>
            ...
            <Link
              ...
              title={'Dodaj dźwięk'}
              className='f5 no-underline black bg-white bg-animate hover-bg-black hover-white inline-flex items-center pa1 ba border-box mb1 mr1'>
              <svg className='w1-7' viewBox='0 0 16 16' stroke='currentcolor' fill='none' strokeWidth='3'>
                <path d='M0 8 L16 8' />
                <path d='M8 0 L8 16' />
              </svg>
            </Link>
